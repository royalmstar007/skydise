                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <i class="fa-solid fa-taxi fa-2x text-primary mb-2"></i>
                                        <h2 class="mb-1" data-toggle="counter-up">987</h2>
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        ...
                                        <h2 class="mb-1" data-toggle="counter-up">1250</h2>
                                        <p class="mb-0">Clients</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="btn btn-primary py-3 px-5 mt-2" href="index">Explore More</a>
                    </div>
